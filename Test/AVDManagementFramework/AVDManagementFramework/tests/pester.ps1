...
Remove-Module AVDManagementFramework -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\AVDManagementFramework.psd1"
Import-Module "$PSScriptRoot\..\AVDManagementFramework.psm1" -Force
