<#
	.SYNOPSIS
		Installs the AVDManagementFramework Module from github
		
	.DESCRIPTION
		This script installs the AVDManagementFramework Module from github.
