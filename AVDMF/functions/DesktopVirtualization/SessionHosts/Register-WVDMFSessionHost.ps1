function Register-WVDMFSessionHost {
    [CmdletBinding()]
    param (
    ...
    process {
        $ResourceName = New-WVDMFResourceName -ResourceType 'VirtualMachine' -AccessLevel $AccessLevel -HostPoolType $HostPoolType -HostPoolInstance $HostPoolInstance -InstanceNumber $InstanceNumber
