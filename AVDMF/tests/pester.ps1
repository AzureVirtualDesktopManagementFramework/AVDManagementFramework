...
Remove-Module WVDManagementFramework -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\WVDManagementFramework.psd1"
Import-Module "$PSScriptRoot\..\WVDManagementFramework.psm1" -Force
